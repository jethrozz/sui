...
export class ExternalConnection extends Connection {
	public static readonly CHANNEL: PortChannelName = 'other_ext<->sui_ui';
	...
	constructor(port: Runtime.Port) {
		...
		console.log('ExternalConnection constructor');
	}
	...
	public async handleExternalMessage(msg: Message) {
		console.log('external handleExternalMessage', msg);
		this.handleMessage(msg);
	}

	protected async handleMessage(msg: Message) {
		console.log('external handleMessage', msg);
		...
		try {
			if (isGetPermissionRequests(payload)) {
				...
				console.log('external getTransactionRequests', payload);
				const txRequests = await Transactions.getTransactionRequests();
				console.log('external getTransactionRequests txRequests', txRequests);
